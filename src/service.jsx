...
const services = [
  {
    title: 'Landing Pages',
    description: 'With React, I build fast, scalable, and dynamic web applications. Whether it\'s a simple landing page or a complex web app, I ensure smooth and interactive user experiences with React.',
    skills: ['React.js & Hooks', 'State Management with useState', 'RESTful API Integration'],
  },

  
  {
    title: 'Figma to React Development',
    description: 'I design modern, user-friendly interfaces that are both visually appealing and easy to navigate. From wireframes to prototypes, I ensure your website is intuitive and responsive on any device.',
    skills: ['(Figma & Adobe XD)', 'Responsive Design', 'Tailwind CSS'],
  },
  {
    title: 'Web Development',
    description: 'I create modern, responsive websites that work seamlessly across devices. Whether it\'s a personal portfolio or a business website, I can bring your ideas to life with clean and efficient code.',
        ...
        <div className="flex flex-wrap justify-center gap-12">
          {services.map((service, index) => (
            <div key={index} className="bg-black border-2 border-white p-8 rounded-lg shadow-lg text-center transition transform hover:scale-105 hover:shadow-xl duration-300 ease-in-out w-[95%] sm:w-80 lg:w-96 flex flex-col">
              ...
              <p className="text-[#ebebeb]   mb-4 flex-grow">{service.description}</p>
